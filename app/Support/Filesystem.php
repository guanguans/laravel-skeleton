...
class Filesystem
{
    ...
    {
        $this->mkdir($path, $this->commandLine->user(), $mode);
    }
    ...
    {
        return $this->touch($path, $this->commandLine->user());
    }
    ...
    {
        $this->put($path, $contents, $this->commandLine->user());
    }
    ...
    {
        $this->append($path, $contents, $this->commandLine->user());
    }
    ...
    public function copyAsUser($from, $to)
    {
        ...
        $this->chown($to, $this->commandLine->user());
    }
    ...
    public function symlinkAsUser($target, $link)
    {
        ...
        $this->commandLine->runAsUser('ln -s '.escapeshellarg($target).' '.escapeshellarg($link));
    }

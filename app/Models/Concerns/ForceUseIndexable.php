 ...
 *
 * @method \Illuminate\Database\Eloquent\Builder<static> useIndex(string|string[] $index)
 * @method \Illuminate\Database\Eloquent\Builder<static> forceIndex(string|string[] $index)
 * @method \Illuminate\Database\Eloquent\Builder<static> ignoreIndex(string|string[] $index)
 *
